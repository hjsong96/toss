   ...
   <div class="content_signin">
         ...
         <div class="btnList">
            <button type="button" class="totalbtn">
               <div class="total">
                  총자산금액<span class="balance-margin"> <c:out
                        value="${totalbalance}" />원 
               </div>
            </button>
               ...
               <c:forEach items="${tossBank}" var="toss">
                  <div class="acc-container">
                     <form action="./main" method="post">
                        ...
                        <button  class="accbtn">
                           <div class="tossbank">${toss.abank}<span
                                 class="balance-margin"> ${toss.abalance}원</span>
                           </div>
                        </button>
                     </form>

                     <form action="./send2" method="post" class="send-button">
                        <input type="hidden" name="aaccount" value="${toss.aaccount}" />
                        <button>송금</button>
                     </form>
                  </div>
               ...
               <c:forEach items="${otherBank}" var="other">
                  <div class="acc-container">
                     <form action="./main" method="post">
                        ...
                        <button  class="accbtn">
                           <div class="otherbank">${other.abank}<span
                                 class="balance-margin">${other.abalance}원</span>
                           </div>
                        </button>
                     </form>
